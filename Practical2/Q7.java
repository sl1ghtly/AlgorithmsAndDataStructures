...
public class Q7 
{
    ...
    {
        //
        // Q7, Q13, Q14 USED ONLY 9 INTEGERS BECAUSE THE OUTPUT WOULD BE THE SAME
        //
        ...
        int[] inserted = is.reversedInsertionSort(numList1);
        System.out.println(Arrays.toString(inserted));
        System.out.println("Selection Sort after sorting: ");
        int[] selected = ss.reversedSelectionSort(numList2);
